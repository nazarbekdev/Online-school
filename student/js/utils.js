...
//         // Access token muddati tugagan bo‘lsa, yangilashga harakat qilamiz
//         try {
...
//         } catch (error) {
//             throw error; // Agar yangilash muvaffaqiyatsiz bo‘lsa, xato qaytadi
//         }
//     }
...
// function logout() {
//     localStorage.removeItem('access_token');
//     localStorage.removeItem('refresh_token'); // Refresh tokenni ham o‘chiramiz
//     window.location.href = 'index.html';
// }
